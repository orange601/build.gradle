...
/**
 * Precompiled myproject.library-conventions script plugin.
 **/
public class MyprojectLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_MyprojectLibraryConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("myproject.java-conventions");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_MyprojectLibraryConventions").asSubclass(BasicScript.class);
